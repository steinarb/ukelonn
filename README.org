...
There is a "user" GUI where they can register the chores they do and check their balance and money owed.  Since my kids mostly interact through their iThings, the webapps GUI aims to be as "app-like" as possible, currently using [[https://vaadin.com/directory/component/vaadin-touchkit][vaadin TouchKit]] to accomplish this.
...
I øyeblikket er det fire hoved-brancher:
 ...
 3. using-react
    Denne branchen vil ha et GUI basert på [[https://reactjs.org][react.js]] med navigasjon mellom skjermbilder besørget av [[https://reactjs.org][react-router v4]], datamodell i [[https://reactjs.org][redux]], med REST-API-kommunikasjon gjort av [[https://reactjs.org][saga]] og [[https://reactjs.org][axios]].  Responsivt mobilvennlig GUI vil bli besørget av [[https://reactjs.org][bootstrap]] (eller kanskje av [[https://reactjs.org][Material Design Lite]]
 4. using-primefaces
