...
Dette trengs for å laste og kjøre programvaren
 ...
 3. Åpne et kommandolinje-vindu og skriv følgende kommandoer:
    #+BEGIN_EXAMPLE
      ...
      mvn -P rebundle-requirements clean install
...
Framgangsmåte:
 1. Klon og bygg webapplikasjonen (regner med at linux-brukere klarer å oversette til noe passende):
    #+BEGIN_EXAMPLE
      ...
      mvn clean install
    #+END_EXAMPLE
 2. [[http://karaf.apache.org/download.html][Last ned Karaf 4.0.9]], pakk ut den nedlastede distribusjonen og start karaf fra kommandlinja
