...
public class AccountTest {
    ...
    public void testProperties() {
        ...
        Account account = new Account(expectedAccountId, expectedUsername, expectedFirstname, expectedLastname, expectedBalance);
    ...
    public void testEquals() {
        ...
        Account accountDifferentAccountId = new Account(2, "jad", "Jane", "Doe", 1);
        assertNotEquals(account, accountDifferentAccountId);
        Account accountDifferentUsername = new Account(1, "jadd", "Jane", "Doe", 1);
        assertNotEquals(account, accountDifferentUsername);
        Account accountDifferentFirstname = new Account(1, "jad", "Julie", "Doe", 1);
        assertNotEquals(account, accountDifferentFirstname);
        Account accountDifferentLastname = new Account(1, "jad", "Jane", "Deer", 1);
        assertNotEquals(account, accountDifferentLastname);
        Account equalAccount = new Account(1, "jad", "Jane", "Doe", 1);
